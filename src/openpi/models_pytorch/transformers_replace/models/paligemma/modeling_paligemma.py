...
class PaliGemmaMultiModalProjector(nn.Module):
    def __init__(self, config: PaliGemmaConfig):
        ...
        # config.vision_config.projection_dim = 2048, set in gemma_pytorch.py
...
class PaliGemmaModel(PaliGemmaPreTrainedModel):
    ...
    def get_image_features(self, pixel_values: torch.FloatTensor):
        ...
        """
        image_outputs = self.vision_tower(pixel_values)                        # (B, 3, 224, 224)
        selected_image_feature = image_outputs.last_hidden_state               # (B, 14x14, D)
        image_features = self.multi_modal_projector(selected_image_feature)    # (B, 14x14, 2048)
